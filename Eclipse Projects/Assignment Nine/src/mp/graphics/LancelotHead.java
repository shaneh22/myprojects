...
public class LancelotHead extends AnImage implements Head{
	static final String INIT_IMAGE_FILE_NAME="lancelot.jpg";
	...
	public LancelotHead(int inputX,int inputY) {
